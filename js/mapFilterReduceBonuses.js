...
// 1. Use `.reduce` to transform the array into an object where the object's keys are ids and the
//    values are objects that represent each user
...
// search and the second argument should be the value you want to search for. If the item does not exist in the
// provided array, return an empty array;
...
// and the second argument should be a value you wish to
...
// PROBLEM 2 - create array of user objects based on the customers array of objects (each user object should just have
// name and age properties)
// HINT: use .map()

// PROBLEM 3 - create an array of civil servant customers (teachers and police officers) containing the same properties
// as the objects on the customers objects
// HINT: use .filter()
